...
def num_tokens_from_text(text, model="gpt-3.5-turbo-0301"):
    """Estimate token count for a chat request body.

    This is an estimator used for batching heuristics, not billing-accurate metering.
    """
    try:
    ...
    # Add a small per-message overhead for role markers and separators.
    # Keep this intentionally simple and model-agnostic for stable heuristics.
    message_overhead = 6
